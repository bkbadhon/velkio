...
const SubAdmin = () => {
    ...
    return (
        <div>
            ...
            <div className="md:w-9/12 border-2 border-gray-300 p-2 mx-auto my-12">




                <h2 className="text-3xl my-4 font-bold text-center">VELKIO SUB ADMIN LIST</h2>
                ...
                <h2 className="md:text-xl text-xl font-semibold my-6">এজেন্ট দের সাথে লেনদেন এর আগে Velkio নিয়ম গুলো জেনে নিন!!</h2>
